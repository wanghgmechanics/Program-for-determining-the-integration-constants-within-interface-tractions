...
% as shown in Table 7 on pages 27-28 for scarf-peel joint.
...
B3 = [-barP0
      0
      -(barP0*bard1*barh2 + barP0*bard2)/(1+barh2)
      0];
F4F5F6F7 = A3\B3; 
...
B6 = [-barP0
      ...
      - C11 -barP0
      - C8
      -(barP0*bard1*barh2 + barP0*bard2- C10*barh2 +C13)/(1+barh2)
...
B12 = [-barP0
      ...
      - H11 -barP0
      - H8
      -(barP0*bard1*barh2 + barP0*bard2- H10*barh2 +H13)/(1+barh2)
