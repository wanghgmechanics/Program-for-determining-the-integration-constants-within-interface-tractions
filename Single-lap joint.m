...
% This is a program for solving the systems of linear equations, as shown in Table 1 on page 18 for single-lap joint
...
% F1 - F3 satisfy:
F3 = 3*barQ0/(2*(1+(1/barE2*barh2)));

A5 = [exp(-gamma1*bara)/gamma1, exp(-gamma2*bara)/gamma2
...
% F4 - F7 satisfy:
A6 = [exp(-gamma4*bara)/gamma4, exp(-gamma5*bara)/gamma5, exp(-gamma6*bara)/gamma6, exp(-gamma7*bara)/gamma7
...
B6 = [-C12
      ...
      C7*bara - C11
      -C7*bara - C8
      -(barB1*barh2 - (C9*barh2+C12)*bara - C10*barh2 +C13)/(1+barh2)
      -(barB2        +(C9*barh2+C12)*bara - C10*barh2 +C13)/(1+barh2)];
...
B12 = [-H12
      ...
      H7*bara - H11
      -H7*bara - H8
      -(barB1*barh2 - (H9*barh2+H12)*bara - H10*barh2 +H13)/(1+barh2)
      -(barB2        +(H9*barh2+H12)*bara - H10*barh2 +H13)/(1+barh2)];
